...
public:															
	...
	double getQuantity() const;											/*!< Gets double quantity from DataItem attributes*/
	void setQuantity(double newQuantity);							/*!< Sets a new quantity for double quantity*/
	std::string toString() const;											/*!< Returns a string format of a class object with its attributes*/
};